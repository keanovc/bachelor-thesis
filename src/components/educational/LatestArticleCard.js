            ...
            <View className="flex flex-row items-center justify-start w-full h-full">
                <View className="flex flex-row items-center justify-start">
                    ...
                    <View className="flex flex-col items-start justify-start px-6">
                        <Text className="text-xs text-gray-300" style={{ fontFamily: "Montserrat-Medium" }}>{article.published_at}</Text>
                    
                        <Text className="text-sm font-bold pt-2 pb-1" style={{ fontFamily: "Montserrat-Bold" }}>
                            { article.title.length > 20 ? article.title.substring(0, 20) + "..." : article.title }  
                        </Text>

                        <Text className="text-xs text-gray-500" style={{ fontFamily: "Montserrat-Light" }}>
